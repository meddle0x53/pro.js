...
},a.Val.prototype.on=function(a){return this.__pro__.properties.v.on(a),this},a.Val.prototype.addTransformator=function(a){return this.__pro__.properties.v.addTransformator(a),this},a.Val.prototype.off=function(a){return this.__pro__.properties.v.off(a),this},a.Val.prototype.into=function(a){return this.__pro__.properties.v.into(a),this},a.Val.prototype.willUpdate=function(a){return this.__pro__.properties.v.willUpdate(a),this},a.Val.prototype.valueOf=function(){return this.__pro__.properties.v.val},a.Val.prototype.toString=function(){return this.valueOf().toString()},a.prob=function(b){var c,d=a.Configuration,e=d.keyprops,f=d.keypropList;if(isAr=a.Utils.isArray,null===b||!a.U.isObject(b)&&!isAr(b))return new a.Val(b);if(isAr(b))return new a.Array(b);try{Object.defineProperty(b,"__pro__",{enumerable:!1,configurable:!1,writeble:!1,value:{properties:{}}}),b.__pro__.state=a.States.init;for(c in b)a.makeProp(b,c);e&&-1!==f.indexOf("p")&&Object.defineProperty(b,"p",{enumerable:!1,configurable:!1,writeble:!1,value:function(a){return this.__pro__.properties[a]}}),b.__pro__.state=a.States.ready}catch(g){throw b.__pro__.state=a.States.error,g}return b},a.makeProp=function(b,c){var d=a.Configuration,e=d.keyprops,f=d.keypropList;if(isF=a.Utils.isFunction,isA=a.Utils.isArrayObject,isO=a.Utils.isObject,e&&-1!==f.indexOf(c))throw Error("The property name "+c+" is a key word for pro objects! Objects passed to Pro.prob can not contain properties named as keyword properties.");!b.hasOwnProperty(c)||null!==b[c]&&void 0!==b[c]?!b.hasOwnProperty(c)||isF(b[c])||isA(b[c])||isO(b[c])?b.hasOwnProperty(c)&&isF(b[c])?new a.AutoProperty(b,c):b.hasOwnProperty(c)&&isA(b[c])?new a.ArrayProperty(b,c):b.hasOwnProperty(c)&&isO(b[c])&&new a.ObjectProperty(b,c):new a.Property(b,c):new a.NullProperty(b,c)},a});